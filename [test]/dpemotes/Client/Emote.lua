...
RegisterCommand("+openDPMenu", function()
  OpenEmoteMenu()
end)
-----------------------------------------------------------------------------------------------------
-- Commands / Events --------------------------------------------------------------------------------
...
function OnEmotePlay(EmoteName)
  ...
  if EmoteName.AnimationOptions.Sound then
    TriggerServerEvent("InteractSound_SV:PlayWithinDistance", 8, EmoteName.AnimationOptions.Sound, 0.1)
  end
...
RegisterKeyMapping('+openDPMenu', 'Menu de Animaciones', 'keyboard', 'OEM_3')