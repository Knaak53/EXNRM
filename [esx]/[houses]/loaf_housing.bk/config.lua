...
Config = {
    SellPercentage = 55, -- percentage of original price you should get back when selling a house.
    ...
    Furniture = { 
        ...
        ['decorations'] = {
            ...
            {'Bicicleta estatica', 'prop_exercisebike', 300},            
            {'Laz', 'p_laz_j02_s', 300}
        },
        ['table'] = {
            {'Mesa para TV', 'prop_tv_cabinet_03', 500},
            {'Farm table', 'prop_ld_farm_table02', 300},
            {'Farm table 2', 'prop_ld_farm_table01', 300},
            {'Mesa de cafe', 'prop_fbi3_coffee_table', 300},
            {'Mesa de cafe 2', 'prop_t_coffe_table', 300},
            {'Mesa de cafe 2', 'prop_t_coffe_table_02', 300},
            {'Tri table', 'prop_tri_table_01', 300},
            {'Mesa protesta', 'prop_protest_table_01', 300},
            {'Escritorio 1', 'v_res_son_desk', 300}, 
            {'Escritorio 2', 'v_res_mddesk', 300},
            {'Mesa de cafe', 'v_res_fh_coftableb', 150},
            {'Mesa de cafe 2', 'v_res_fh_coftablea', 150},
        ...
        ['electronics'] = {
            {'TV plasma', 'prop_tv_flat_02', 750},
            {'TV plasma', 'prop_tv_06', 350},
            {'TV plasma S', 'prop_tv_02', 250},
            {'Radio', 'prop_portable_hifi_01', 100},
            {'Ordenador gamer', 'prop_dyn_pc_02', 500},
            {'Ordenador oficina', 'prop_pc_01a', 100},
            {'Monitor', 'prop_monitor_01c', 75},
            {'Monitor 2', 'prop_ld_monitor_01', 75},
            {'Monitor 3', 'prop_monitor_03b', 25},
            {'Telefono', 'p_amb_phone_01', 75},
            {'Telefono antiguo', 'prop_v_m_phone_o1s', 75},
            {'Telefono oficina', 'prop_office_phone_tnt', 75},
       ...
       --[[ ['Drugs'] = {
        ...
        ['FoodandDrinks'] = {
            {'Cuenco de cacahuetes', 'prop_peanut_bowl_01', 50},
            {'Cuenco', 'prop_cs_bowl_01', 50},
            {'BS Cup', 'prop_cs_bs_cup', 50},
            {'Cafe', 'p_ing_coffeecup_02', 50},
            {'Frutero 1', 'prop_fruit_stand_03', 50},
            {'Frutero 2', 'prop_fruit_stand_02', 50},
            {'Frutero 3', 'prop_fruit_stand_01', 50},
            {'Frutero 4', 'prop_fruit_stand_03', 50},
            {'Frutero 5', 'prop_fruit_stand_03', 50},
            {'Caja de birra', 'prop_cs_beer_box', 50},
        ...
        ['lights'] = {
            {'Luces ', 'prop_cd_lamp', 150},
            {'Luces 2', 'v_res_desklamp', 150},
            {'Luces 3', 'v_corp_cd_desklamp', 150},
            {'Luces 4', 'v_res_d_lampa', 150},
            {'Luces 5', 'v_res_fh_floorlamp', 150},
            {'Luces 6', 'v_res_fa_lamp1on', 150},
            {'Luces 7', 'v_res_j_tablelamp1', 150},
            {'Luces 8', 'v_res_j_tablelamp2', 150},
            {'Luces 9', 'v_res_mplanttongue', 150},
            {'Luces 10', 'v_res_m_lampstand', 150},
            {'Luces 11', 'v_res_m_lampstand2', 150},
            {'Luces 12', 'v_res_mtblelampmod', 150},
            {'Luces 13', 'v_res_m_lamptbl', 150},
            {'Luces 14', 'v_res_tre_lightfan', 150},
            {'Luces 15', 'v_res_tre_talllamp', 150},
            {'Luces 16', 'v_ret_fh_walllighton', 150},
            {'Luces 17', 'v_ret_gc_lamp', 150},
            {'Luces 18', 'v_res_m_lamptbl', 150},
            {'Luces 19', 'hei_prop_hei_bnk_lamp_02', 150},
            {'Luces 20', 'prop_ld_cont_light_01', 150},
            {'Luces 21', 'hei_prop_hei_bnk_lamp_01', 150},
            {'Luces 22', 'prop_chall_lamp_02', 150},
            {'Luces 23', 'v_ilev_fh_lampa_on', 150},
            {'Luces 24', 'prop_construcionlamp_01', 150},
            {'Luces 25', 'hei_prop_bank_ornatelamp', 150},
            {'Luces 26', 'prop_kino_light_03', 150},
            {'Luces 27', 'prop_oldlight_01c', 150},
            {'Luces 28', 'prop_recycle_light', 150},
            {'Luces 29', 'prop_studio_light_01', 150},
            {'Luces 30', 'prop_studio_light_02', 150},
            {'Luces 25', 'hei_prop_bank_ornatelamp', 150},
            {'Luces 26', 'prop_wall_light_02a', 150},
            {'Luces 27', 'prop_wall_light_03a', 150},
            {'Luces 28', 'prop_wall_light_04a', 150},
            {'Luces 29', 'prop_wall_light_05a', 150},
            {'Luces 30', 'prop_wall_light_05c', 150}

          },
        
          ['kitchen'] = {
            {'Cafetera', 'apa_mp_h_acc_coffeemachine_01', 150},
            {'Scale', 'bkr_prop_coke_scale_01', 150},
            {'Basura', 'hei_heist_kit_bin_01', 150},
        ...
        ['Bins'] = {
            {'Basura 1', 'prop_cs_bin_02', 100}, 
            {'Basura 2', 'prop_cs_bin_03', 100}, 
            {'Basura 3', 'prop_fbibombbin', 100}, 
            {'Basura 4', 'prop_rub_binbag_sd_01', 100},
            {'Basura 5', 'prop_rub_binbag_sd_01', 100},
            {'Basura 6', 'prop_bin_04a', 150},
            {'Basura 7', 'prop_bin_07a', 150},
            {'Basura 8', 'prop_bin_06a', 150},
            {'Basura 9', 'prop_bin_10b', 150},
            {'Basura 10', 'prop_bin_11b', 150},
            {'Basura 11', 'prop_bin_11a', 150},
            {'Basura grande', 'prop_bin_13a', 150},
        ...
        ['accessory'] = {
            ...
            {'Paquete de tabaco', 'p_cigar_pack_02_s', 75},
            {'Paquete de tabaco 2', 'p_fag_packet_01_s', 75},
            {'Cartera', 'prop_ld_wallet_01_s', 75},
            {'Bolsa de mano', 'prop_ld_handbag_s', 75},
            {'Mochila', 'prop_m_pack_int_01', 75},
            {'Mochila 2', 'prop_cs_heist_bag_02', 75},
            {'Bolso', 'prop_nigel_bag_pickup', 75},
            {'Maleta', 'prop_ld_suitcase_01', 75}
        },
    },

    Furnituring = { -- change position of where you buy furniture here.
        ['enter'] = vector3(29.59, -1752.89, 28.3),
        ['teleport'] = vector3(30.37, -1752.76, 800.0035),
    },
...
Strings = {
    ...
    ['Manage_House'] = 'Gestionar propiedad',
    ['Buy_House'] = 'Comprar casa nº:%s',
    ['Knock_House'] = 'Llamar al timbre',
    ['Your_House'] = 'Tu casa',
    ['Buyable_House'] = 'Propiedades a la venta',
    ['Player_House'] = 'Casa del jugador',
    ['Storage'] = 'Acceder al armario',
    ['Sell_House'] = 'Vender por %s€',
    ['Enter_House'] = 'Entrar',
    ['Sell_Confirm'] = 'Seguro que quieres vender por %s€?',
    ['yes'] = 'Si',
    ['no'] = 'No',
    ['Sold_House'] = 'Has vendido la propiedad por %s€',
    ['Must_Sell'] = 'Solo puedes poseer una vivienda. Vende tu vivienda actual para poder adquirir esta.',
    ['Buy_House_Confirm'] = 'Comprar casa nº:%s por %s€?',
    ['Manage_Door'] = 'Gestionar casa',
    ['Accept'] = 'Dejar entrar a alguien',
    ['Exit'] = 'Salir',
    ['Noone_Home'] = 'Parece que no hay nadie en casa!',
    ['Someone_Knocked'] = 'Alguien está tocando el timbre. Ve a la puerta para abrir!',
    ['Let_In'] = 'Dejar entrar a alguien',
    ['Accept_Player'] = 'Dejar que %s entre?',
    ['Waiting_Owner'] = 'Esperando a que el dueño te abra la puerta.',
    ['Buy_Furniture'] = 'Entrar a muebles Caronte',
    ...
    ['Furnish'] = 'Amueblar casa',
    ['Store_Garage'] = 'Pulsa ~INPUT_CONTEXT~ para guardar el vehiculo', 
    ['Re_Furnish'] = 'Quitar muebles de la casa',
    ['Remove'] = 'Quitar %s (nº:%s)',
    ['Amount'] = 'Cuantos?',
    ['Player_Inventory'] = 'Tu inventario',
    ['House_Inventory'] = 'Almacen de tu casa',
    ['Invalid_Amount'] = 'Cantidad incorrecta. Por favor, introduce un numero.',
    ['Store'] = 'Guardar',
    ['Withdraw'] = 'Retirar',
    ['Storage_Title'] = 'Trastero',
    ['You_Stored'] = 'Has guardado %sx %s',
    ['You_Withdrew'] = 'Has retirado %sx %s',
    ['Not_Enough'] = 'No tienes suficiente de eso!',
    ['Not_Enough_House'] = 'No hay suficiente de eso en el inventario!',
    ['Weapons'] = 'Armas',
    ['Items'] = 'Objetos',
    ['No_Weapon'] = 'No llevas ese arma!',
    ['bullets'] = 'Balas', 
    ['Rotation'] = 'Rotacion',
    ['Guests'] = 'Tus invitados deben salir de la casa antes de poder hacer eso!',
    ['Garage'] = 'Entrar al garaje',
    ['No_Spawn'] = 'No hay sitio para spawnear tu casa, espera a que algun jugador abandone la suya.',
    ['Host_Left'] = 'El dueño de la casa se ha desconectado, por eso se te ha echado de la propiedad.',
    ['No_Money'] = 'No tienes suficiente dinero!',
