...
AddEventHandler('kashactersC:SpawnCharacter', function(spawn, isnew)
    ...
    if isnew == true then
        TriggerEvent('ToggleActionmenu')
        TriggerEvent('esx_identity:showRegisterIdentity', true)
        Citizen.Wait(1200000)
        TriggerEvent("esx_custom_messages:showMessage", 'OPORTUNIDADES EN PALETO', 'Hey, me ha contado un pajarito que acabas de llegar a la ciudad, tengo un par de negocios que pueden interesar a los recien llegados. Si quieres saber mas, buscame en Paleto Bay.', 'mafia2.png', 'paleto_wellcome.mp3', true, 10000)
    end
end)
