local skinData = {
	...
	centerCoords = {-0.032,0.652},

	lightsLoc = {0.197,-0.043,0.018,0.02},
	blinkerLoc = {0.04,0.12,0.022,0.03},
	fuelLoc = {0.203,-0.002,0.020,0.025},
	oilLoc = {0.185,-0.08,0.020,0.025},
	engineLoc = {0.1625,-0.11,0.020,0.025},
	...
	FuelBGLoc = {0.220, -0.002,0.020, 0.025},
	FuelGaugeLoc = {0.220,-0.002,0.020,0.025},
