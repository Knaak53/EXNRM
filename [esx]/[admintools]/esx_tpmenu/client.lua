...
table.insert(elements, { label = 'Weed farm',  x = 1051.491, y = -3196.536, z = -39.20 })
table.insert(elements, { label = 'Meth farm',  x = 1009.5, y = -3196.6, z = -38.99682 })
table.insert(elements, { label = 'Coke farm',  x = 1093.6, y = -3196.6, z = -38.99841 })
table.insert(elements, { label = 'Yate',  x = -1363.724, y = 6734.108, z = 2.44598 })
table.insert(elements, { label = 'Documentos falsos', x = 1165, y = -3196.6, z = -40.01306 })
table.insert(elements, { label = 'Biker 1', x = 1107.04, y = -3157.399, z = -37.51859 })
table.insert(elements, { label = 'Biker 2', x = 998.4809, y = -3164.711, z = -38.90733 })
table.insert(elements, { label = 'Cars warehouse', x = 994.5925, y = -3002.594, z = -39.64699 })
table.insert(elements, { label = 'Lavar dinero', x = 1121.897, y = -3195.338, z = -40.4025})
table.insert(elements, { label = 'fake DNI', x = 1166.6, y = -3197.45, z = -39.10})
table.insert(elements, { label = 'Casino', x = -1604.664, y = -3012.583, z = -78.010})
table.insert(elements, { label = 'ofi', x = 3217.697, y = -4834.826, z = 111.8152})
