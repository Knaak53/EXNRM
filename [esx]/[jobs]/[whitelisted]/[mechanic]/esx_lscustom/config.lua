...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = -221.42, y = -1329.78, z = 30.89},
	...
	ls3 = {
		Pos   = { x = 731.81, y = -1088.82, z = 22.73},
		Size  = {x = 2.0, y = 2.0, z = 2.2},
		Color = {r = 0, g = 0, b = 204},
		Marker= 36,
	...
	ls4 = {
		Pos   = { x = 1175.04, y = 2640.21, z = 38.32},
		Size  = {x = 2.0, y = 2.0, z = 2.2},
		Color = {r = 0, g = 0, b = 204},
		Marker= 36,
	...
	ls5 = {
		Pos   = { x = 110.99, y = 6626.39, z = 31.89},
		Size  = {x = 2.0, y = 2.0, z = 2.2},
		Color = {r = 0, g = 0, b = 204},
		Marker= 36,
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {16.95, 20.56, 23.12, 28.53}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {7.65, 8.3, 9.6, 11.95}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {8.95, 15.93, 18.51}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {5.72, 10.44, 12.88, 15.77, 17.8}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {14.1, 16.28, 18.00, 20.00, 23.00, 27.00}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
