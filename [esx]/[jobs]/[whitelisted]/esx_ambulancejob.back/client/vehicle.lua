...
Citizen.CreateThread(function()
    ...
    if not DoesEntityExist(pedEntity2) then
        pedEntity2 = CreatePed(4, hash, Config.Hospitals.CentralLosSantos.Vehicles[1].Spawner.x, Config.Hospitals.CentralLosSantos.Vehicles[1].Spawner.y, Config.Hospitals.CentralLosSantos.Vehicles[1].Spawner.z, 68.62)
    ...
    if not DoesEntityExist(pedEntity3) then
        pedEntity3 = CreatePed(4, hash, Config.Hospitals.CentralLosSantos.Helicopters[1].Spawner.x, Config.Hospitals.CentralLosSantos.Helicopters[1].Spawner.y, Config.Hospitals.CentralLosSantos.Helicopters[1].Spawner.z, 262.52)
...
RegisterNetEvent('esx_ambulancejob:open_garage_ui')
AddEventHandler('esx_ambulancejob:open_garage_ui', function()
...
RegisterNetEvent('esx_ambulancejob:open_heli_ui')
AddEventHandler('esx_ambulancejob:open_heli_ui', function()
	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'ambulance' then
