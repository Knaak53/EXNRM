Locales['es'] = {
  ...
  ['get_weapon_type_menu'] = 'Armory - Tipos de armas',
  -- Vehicles
  ...
  ['license_revoked'] = '¡tu ~b~%s~s~ se te ha ~y~confiscado~s~!',
  ['licence_you_revoked'] = 'has confiscado a ~b~%s~s~ que pertenecía a ~y~%s~s~',
  ...
  ['no_identity_card'] = 'El civil no dispone de carnet de identidad',
  ['identity_card_photo'] = 'Hacer foto para el carnet y validar DNI',
  ['view_identity_card'] = 'Ver documento de identidad'
}
