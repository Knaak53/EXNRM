$(document).ready(()=> {
    ...
    window.addEventListener('message', function (event) {
        console.log("Me llega asfasfdasdasdad")
    ...
    function ShowNotif(data) {
            ...
            setTimeout(function() {
                $.when($notification.fadeOut(0)).done(function() {
                    $notification.remove()
                });
    ...
    function CreateNotification(data) {
        ...
        <div id="alert-info"><i class="fas fa-globe-europe"></i>Calle: ' + data.info["loc"] + ', Distancia: '+data.info["dist"]+'m</div>\
