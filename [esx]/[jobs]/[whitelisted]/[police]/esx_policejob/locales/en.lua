Locales['en'] = {
  ...
  ['no_outfit'] = 'No hay ningun uniforme para ti!',
  ['open_cloackroom'] = 'Pulsa ~INPUT_CONTEXT~ para usar el ~y~vestuario~s~.',
  -- Armory
  ...
  ['vehicle_blocked'] = 'Todos los puntos de aparicion estan ocupados!!',
  ['garage_prompt'] = 'Pulsa ~INPUT_CONTEXT~ para acceder a ~y~Acciones del vehiculo~s~.',
  ['garage_title'] = 'Acciones del vehiculo',
  ['garage_stored'] = 'En garaje',
  ['garage_notstored'] = 'fuera de garaje',
  ['garage_storing'] = 'Se va a retirar el vehiculo, no debe haber jugadores cerca',
  ['garage_has_stored'] = 'El vehiculo se ha guardado en el garaje',
  ['garage_has_notstored'] = 'No se han encontrado vehiculos cercanos',
  ['garage_notavailable'] = 'El vehiculo no esta en el garaje.',
