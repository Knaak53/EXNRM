...
Config.BagPay       = 10    -- Pague por sacola puxada do lixo.
...
Config.Cloakroom = {
	CloakRoom = {
			Pos   = {x = -321.66, y = -1546.01, z = 30.02},
...
Config.Zones = {
	VehicleSpawnPoint = {
			Pos   = vector3(-328.50, -1520.99, 27.53),
...
-- Los Santos
	-- fleeca
	Delivery1LS = {
			Pos   = vector3(114.83280181885,-1462.3127441406, 29.295083999634),
...
-- 2nd Patrol
	...
	RetourCamion = {
			Pos   = {x = -345.88, y = -1530.89, z = 28.565467834473},
			Color = {r = 204, g = 0, b = 0},
