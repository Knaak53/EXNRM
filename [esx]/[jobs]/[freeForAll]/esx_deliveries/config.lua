...
Config.Base = {
	-- Blip coords
	coords  = vector3(913.99, -1728.70, 30.16),
	-- Scooter mark
	scooter = vector3(913.99, -1728.70, 30.16),
	-- Return vehicle mark
	retveh  = vector3(897.46, -1737.21, 30.33),
	-- Delete vehicle mark
	deleter = vector3(901.01, -1732.04, 30.47),
	-- Heading
	heading = 245.0,
}
...
Config.Models = {
	scooter = 'faggio3',
	van     = 'rumpo3',      -- Chinese car Wuling hong guang S1
	truck   = 'mule2',
	vehDoor = {
...
Config.ParkingSpawns = {
	vector3(907.04, -1735.25, 30.59),
	vector3(912.28, -1736.37, 30.65)
}
