...
Config.Weapons = {
	...
	{name = 'WEAPON_REVOLVER', label = _U('weapon_revolver'), weight = 2000, tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_PISTOL'}},
	{name = 'WEAPON_MARKSMANPISTOL', label = _U('weapon_marksmanpistol'), weight = 2000, tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_PISTOL'}},
	{name = 'WEAPON_DOUBLEACTION', label = _U('weapon_doubleaction'), weight = 2000, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_PISTOL'}},
	...
	{name = 'WEAPON_DBSHOTGUN', label = _U('weapon_dbshotgun'), weight = 3500, tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_shells'), hash = 'AMMO_SHOTGUN'}},
	{name = 'WEAPON_AUTOSHOTGUN', label = _U('weapon_autoshotgun'),weight = 4000, tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_shells'), hash = 'AMMO_SHOTGUN'}},
	{name = 'WEAPON_MUSKET', label = _U('weapon_musket'),weight = 4500, tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_SHOTGUN'}},
	...
	{name = 'WEAPON_MINIGUN', label = _U('weapon_minigun'),weight = 6, tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_MINIGUN'}},
	{name = 'WEAPON_RAILGUN', label = _U('weapon_railgun'),weight = 6, tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = 'AMMO_RAILGUN'}},
	{name = 'WEAPON_STUNGUN', label = _U('weapon_stungun'),weight = 6, tints = Config.DefaultWeaponTints, components = {}},
	{name = 'WEAPON_RPG', label = _U('weapon_rpg'),weight = 6, tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rockets'), hash = 'AMMO_RPG'}},
	{name = 'WEAPON_HOMINGLAUNCHER', label = _U('weapon_hominglauncher'),weight = 6, tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rockets'), hash = 'AMMO_HOMINGLAUNCHER'}},
	{name = 'WEAPON_GRENADELAUNCHER', label = _U('weapon_grenadelauncher'),weight = 6, tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_grenadelauncher'), hash = 'AMMO_GRENADELAUNCHER'}},
	{name = 'WEAPON_COMPACTLAUNCHER', label = _U('weapon_compactlauncher'),weight = 6, tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_grenadelauncher'), hash = 'AMMO_GRENADELAUNCHER'}},
	{name = 'WEAPON_FLAREGUN', label = _U('weapon_flaregun'),weight = 2, tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_flaregun'), hash = 'AMMO_FLAREGUN'}},
	{name = 'WEAPON_FIREEXTINGUISHER', label = _U('weapon_fireextinguisher'),weight = 6, components = {}, ammo = {label = _U('ammo_charge'), hash = 'AMMO_FIREEXTINGUISHER'}},
	{name = 'WEAPON_PETROLCAN', label = _U('weapon_petrolcan'),weight = 6, components = {}, ammo = {label = _U('ammo_petrol'), hash = 'AMMO_PETROLCAN'}},
	{name = 'WEAPON_FIREWORK', label = _U('weapon_firework'),weight = 6, components = {}, ammo = {label = _U('ammo_firework'), hash = 'AMMO_FIREWORK'}},
	{name = 'WEAPON_FLASHLIGHT', label = _U('weapon_flashlight'),weight = 0.5, components = {}},
	{name = 'GADGET_PARACHUTE', label = _U('gadget_parachute'),weight = 3, components = {}},
	{name = 'WEAPON_KNUCKLE', label = _U('weapon_knuckle'),weight = 0.5, components = {}},
	{name = 'WEAPON_HATCHET', label = _U('weapon_hatchet'),weight = 2.5, components = {}},
	{name = 'WEAPON_MACHETE', label = _U('weapon_machete'),weight = 2, components = {}},
	{name = 'WEAPON_SWITCHBLADE', label = _U('weapon_switchblade'),weight = 2.5, components = {}},
	{name = 'WEAPON_BOTTLE', label = _U('weapon_bottle'),weight = 0.5, components = {}},
	{name = 'WEAPON_DAGGER', label = _U('weapon_dagger'),weight = 0.5, components = {}},
	{name = 'WEAPON_POOLCUE', label = _U('weapon_poolcue'),weight = 0.5, components = {}},
	{name = 'WEAPON_WRENCH', label = _U('weapon_wrench'),weight = 1.5, components = {}},
	{name = 'WEAPON_BATTLEAXE', label = _U('weapon_battleaxe'),weight = 2.5, components = {}},
	{name = 'WEAPON_KNIFE', label = _U('weapon_knife'),weight = 0.8, components = {}},
	{name = 'WEAPON_NIGHTSTICK', label = _U('weapon_nightstick'), weight = 0.5, components = {}},
	{name = 'WEAPON_HAMMER', label = _U('weapon_hammer'),weight = 1, components = {}},
	{name = 'WEAPON_BAT', label = _U('weapon_bat'),weight = 1.5, components = {}},
	{name = 'WEAPON_GOLFCLUB', label = _U('weapon_golfclub'),weight = 1, components = {}},
	{name = 'WEAPON_CROWBAR', label = _U('weapon_crowbar'),weight = 1.5, components = {}},

	{name = 'WEAPON_GRENADE', label = _U('weapon_grenade'),weight = 0.5, components = {}, ammo = {label = _U('ammo_grenade'), hash = 'AMMO_GRENADE'}},
	{name = 'WEAPON_SMOKEGRENADE', label = _U('weapon_smokegrenade'),weight = 0.5, components = {}, ammo = {label = _U('ammo_smokebomb'), hash = 'AMMO_SMOKEGRENADE'}},
	{name = 'WEAPON_STICKYBOMB', label = _U('weapon_stickybomb'), weight = 1, components = {}, ammo = {label = _U('ammo_stickybomb'), hash = 'AMMO_STICKYBOMB'}},
	{name = 'WEAPON_PIPEBOMB', label = _U('weapon_pipebomb'),weight = 1, components = {}, ammo = {label = _U('ammo_pipebomb'), hash = 'AMMO_PIPEBOMB'}},
	{name = 'WEAPON_BZGAS', label = _U('weapon_bzgas'),weight = 1, components = {}, ammo = {label = _U('ammo_bzgas'), hash = 'AMMO_BZGAS'}},
	{name = 'WEAPON_MOLOTOV', label = _U('weapon_molotov'),weight = 1, components = {}, ammo = {label = _U('ammo_molotov'), hash = 'AMMO_MOLOTOV'}},
	{name = 'WEAPON_PROXMINE', label = _U('weapon_proxmine'),weight = 1, components = {}, ammo = {label = _U('ammo_proxmine'), hash = 'AMMO_PROXMINE'}},
	{name = 'WEAPON_SNOWBALL', label = _U('weapon_snowball'),weight = 0.1, components = {}, ammo = {label = _U('ammo_snowball'), hash = 'AMMO_SNOWBALL'}},
	{name = 'WEAPON_BALL', label = _U('weapon_ball'),weight = 0.2, components = {}, ammo = {label = _U('ammo_ball'), hash = 'AMMO_BALL'}},
	{name = 'WEAPON_FLARE', label = _U('weapon_flare'), weight = 1, components = {}, ammo = {label = _U('ammo_flare'), hash = 'AMMO_FLARE'}}
}
