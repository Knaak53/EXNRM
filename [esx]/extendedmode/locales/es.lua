Locales['es'] = {
  ...
  ['received_weapon_ammo'] = 'has recibido ~o~%sx %s~s~ a tu ~b~%s~s~ de ~b~%s~s~',
  ...
  ['received_weapon_noweapon'] = '~b~%s~s~ has intentado darle munición a ~y~%s~s~, pero no tienes uno',
  ...
  ['threw_weapon_already'] = 'Ya has tirado ese arma',
  ...
  ['company_nomoney'] = '¡Tu empresa tiene muy poco dinero y no puede pagar tu salario, trabaja más duro o habla con tu jefe!',
  ['received_paycheck'] = 'Sueldo recibido',
  ['bank'] = 'Banco',
  ['account_bank'] = 'banco',
  ...
  ['command_giveaccountmoney_amount'] = 'cantidad para añadir',
  ['command_giveaccountmoney_reason'] = 'razón administrativa : Id del ticket, id del reporte ó Id del bug report',
  ...
  ['command_giveweapon_ammo'] = 'recuento de municiónes',
  ...
  ['command_setjob__reason'] = 'razón administrativa : Id del ticket, id del reporte, Id del bug report o "Venta" si es una venta de facción',
  ['command_setjob_invalid'] = 'el trabajo o el grado son inválidos',
  ['command_setgroup'] = 'establecer grupo del jugador',
  ['command_setgroup_group'] = 'Nombre del grupo',
  ['commanderror_argumentmismatch'] = 'el argumento no coinciden (se paso %s, se esperaba %s)',
  ...
  ['ammo_charge'] = 'cargas',
  ['ammo_petrol'] = 'mililitros de combustible',
