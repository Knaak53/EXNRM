...
function ApplySkin(skin, clothes)
	...
	SetPedHeadBlendData(playerPed, Character['dad'], Character['mum'], Character['gen'], Character['skin'], Character['skin'], Character['skin'], Character['dadmumpercent'] * 0.1, Character['dadmumpercent'] * 0.1, 1.0, true)
...
AddEventHandler('skinchanger:loadSkin', function(skin, cb)
	print("skin recieved, apllying")
	local skinAux = skin
	if type(skin) == "string" then
		skinAux = json.decode(skin)
		skin = skinAux.skin
	end
