...
BikerClubhouse1 = {
    ...
    LoadDefault = function()
        ...
        BikerClubhouse1.Walls.Set(BikerClubhouse1.Walls.plain, BikerClubhouse1.Walls.Color.lightGray)

        BikerClubhouse1.Furnitures.Set(BikerClubhouse1.Furnitures.B, 3)
        BikerClubhouse1.Decoration.Set(BikerClubhouse1.Decoration.B)
        BikerClubhouse1.Mural.Set(BikerClubhouse1.Mural.fist)

        BikerClubhouse1.ModBooth.Set(BikerClubhouse1.ModBooth.on)
        BikerClubhouse1.GunLocker.Set(BikerClubhouse1.GunLocker.on)

        BikerClubhouse1.Meth.Set(BikerClubhouse1.Meth.stage2)
        BikerClubhouse1.Cash.Set(BikerClubhouse1.Cash.stage2)
        BikerClubhouse1.Coke.Set(BikerClubhouse1.Coke.stage2)
        BikerClubhouse1.Weed.Set(BikerClubhouse1.Weed.stage2)
