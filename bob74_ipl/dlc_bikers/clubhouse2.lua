...
BikerClubhouse2 = {
    ...
    LoadDefault = function()
        ...
        BikerClubhouse2.LowerWalls.SetColor(BikerClubhouse2.Walls.Color.blue)

        BikerClubhouse2.Furnitures.Set(BikerClubhouse2.Furnitures.A, BikerClubhouse2.Furnitures.Color.red)
